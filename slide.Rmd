...
- 2020/4/4時点の最新版は、3.6.2(2020/4/24 に4.0.0リリース)

![rver4](./slide_img/New4.png)

- おすすめのIDE（統合開発環境）は、[RStudio](https://rstudio.com/)

## R のパッケージ {#packages}
- R のパッケージを使うことで、世界中で開発されている便利な手法を使える
- パッケージに含まれている関数を呼び出すことで、様々な拡張昨日を使う
- パッケージは、関数の集まり
...
- R 4..0.0 では `stringsAsFactors = FALSE` がデフォルトになるそうです。
...
## 余談 {#yodan}
![dplyr1](./slide_img/dplyr1.png)

## 本資料について
- revealjs パッケージで作りました。
- 以下の URL で公開しています。 <br> https://ymattu.github.io/TokyoR84/slide.html#/
